        ...
        <div
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <c:if test="${sessionScope.loginedUser.isAdmin()}">
                    <li class="nav-item" role="presentation"><a class="nav-link" href=${PathToPage.CREATE_RECIPE_PATH}>create</a>
                    </li>
                </c:if>
        ...
        <div class="container">
            <div class="block-heading">
                ...
                <c:if test="${recipes.isEmpty()}">
                    <h1 class="text-info">There is no recipes with such ingredieents</h1>
                </c:if>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card"><img class="card-img-top w-100 d-block" src=<c:out value="${recipe.getImage()}"/>>
                        <div class="card-body">
                            ...
                            <p class="card-text"><c:out value="${recipe.getDescription().substring(0,recipe.getDescription().indexOf('.'))}"/></p>
                        </div>
                        <div>
                            <button class="btn btn-outline-primary btn-sm" type="button"
                                    onclick="location.href = '/recipe?id=${recipe.getId()}';">Learn More
                            </button>
                        </div>
